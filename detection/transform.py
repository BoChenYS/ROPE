...
class GeneralizedRCNNTransform(nn.Module):
    ...
    def postprocess(self,
        ...
        for i, (pred, im_s, o_im_s) in enumerate(zip(result, image_shapes, original_image_sizes)):
            ...
            if "keypoints1" in pred:
                keypoints1 = pred["keypoints1"]
                keypoints1 = resize_keypoints(keypoints1, im_s, o_im_s)
                result[i]["keypoints1"] = keypoints1
            if "keypoints2" in pred:
                keypoints2 = pred["keypoints2"]
                keypoints2 = resize_keypoints(keypoints2, im_s, o_im_s)
                result[i]["keypoints2"] = keypoints2
            if "keypoints3" in pred:
                keypoints3 = pred["keypoints3"]
                keypoints3 = resize_keypoints(keypoints3, im_s, o_im_s)
                result[i]["keypoints3"] = keypoints3
        return result
